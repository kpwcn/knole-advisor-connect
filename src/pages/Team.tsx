      ...
      <section className="py-12 bg-white">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center overflow-hidden bg-white p-4 rounded-lg">
              <div className="animate-slide flex items-center space-x-6">
        ...
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white text-primary border border-university-green/20 hover:bg-university-green/5 transition-smooth px-8 py-3 rounded-lg font-semibold"
            >
              Apply
            </a>
          </div>
